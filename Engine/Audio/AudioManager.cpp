...
class AudioPlayerOsx : public AudioManager {
 public:
  ...
  double duration() const {
    ...
    OSStatus
        status = AudioFileGetProperty(aqData.mAudioFile, kAudioFilePropertyEstimatedDuration, (UInt32 *) &sz, &dur);
    checkStatus(status);
    return dur;
  }
